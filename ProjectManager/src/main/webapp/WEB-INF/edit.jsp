...
<div >
 <form:form action="/projects/edit/${project.id}" method="post" modelAttribute="project" class="col-4 p-4 bg-success text-light" style="height:65vh;">
<input type="hidden" name="_method" value="put"> 
	...
	<a href="/dashboard" class="btn btn-danger" style="margin-top:10px;">Cancel</a>
